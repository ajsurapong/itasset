...
// =========== Services ===========
// ============= Upload ==============
router.post("/uploading/:email", authCheck, function (req, res) {
...
router.post("/uploadif/:email", authCheck, function (req, res) {
    const email = req.params.email
    upload(req, res, function (err) {
        if (err) {
            // An unknown error occurred when uploading.
...
router.put("/item/addImage", authCheck, function (req, res) {
...
router.get("/manageUser/showAllUsers/:Email_user", authCheck, function (req, res) {
...
router.get("/adminhistorytableEmailCommittee/info/:year", authCheck, function (req, res) {
    const Year = req.params.year;
...
// // Load info of commitee
router.get("/adminhistorytableEmailCommittee/infoshow", authCheck, function (req, res) {
...
router.get("/adminhistorytableEmailCommittee/year", authCheck, function (req, res) {
...
router.get("/adminhistorytable/info/:EmailCommittee/:year", authCheck, function (req, res) {
...
router.get("/EmailCommitteename/info/:Email_name", authCheck, function (req, res) {
...
router.get("/committee/checkedItems/:year", authCheck, function(req, res) {
...
router.get("/user/profile/inspectedItem/Total/Number1/:Email_Committee", authCheck, function (req, res) {
...
router.get("/user/datescan", authCheck, function (req, res) {
    const Year = new Date().getFullYear();
...
// Load inspected total item numbers by a user
router.get("/user/profile/inspectedItem/Total/Number/:Email_Committee", authCheck, function (req, res) {
    const Email_Committee = req.params.Email_Committee;
...
router.get("/user/profile/inspectedItem/:Status/:Email_Committee", authCheck, function (req, res) {
    const Email_Committee = req.params.Email_Committee;
    const Status = req.params.Status;
...
// Load Year
router.get("/Year/user", authCheck, function (req, res) {
...
// Load date scan
router.get("/datescan/user", authCheck, function (req, res) {
    // const Year = new Date().getFullYear();
...
// Load Year
router.get("/Year/iteem", authCheck, function (req, res) {
...
router.put("/manageUser/update/:Email_user/:Email_assigner/:Role/:Email_useru", authCheck, function (req, res) {
    const Email_user = req.params.Email_user;
...
router.put("/manageUser/updatename/:Name/:Email_user", authCheck, function (req, res) {
...
// Load email of user
router.get("/user/index/info/emailUser/:Email_user", authCheck, function (req, res) {
    const Email_user = req.params.Email_user;
    const sql = "SELECT Email_user FROM `year_user` WHERE Email_user=?;"
...
router.get("/user/profile/inspectedInfoItem/:Email_Committee", authCheck, function (req, res) {
    const Email_Committee = req.params.Email_Committee;
...
// Load all item info
router.get("/item/dashboard/showAllInfo", authCheck, function (req, res) {
...
router.get("/item/dashboard/showuser", authCheck, function (req, res) {
...
router.get("/item/dashboard/showAllInfo/:location/:email/:year", authCheck, function (req, res) {
...
// Load all item info with location
router.get("/item/dashboard/showAllInfoall/:location/:year", authCheck, function (req, res) {
    const location = req.params.location;
    const year = req.params.year;
...
// Load item numbers
router.get("/item/dashboard/number/:status", authCheck, function (req, res) {
...
// Load all item info with location
router.get("/item/dashboard/showAllInfo/:Room/:year", authCheck, function (req, res) {
...
// Load item numbers
router.get("/item/dashboard/number", authCheck, function (req, res) {
...
// Load item numbers
router.get("/item/dashboard/number2/:status/:Year", authCheck, function (req, res) {
...
router.get("/item/dashboard/number2user/:status/:Year/:email", authCheck, function (req, res) {
...
router.get("/item/dashboard/number1/:Year", authCheck, function (req, res) {
...
// Load item numbers Year
router.get("/item/dashboard/number1all/:Year/:email", authCheck, function (req, res) {
...
// // Load location
router.get("/item/Location/:year", authCheck, function (req, res) {
    const year = req.params.year
...
// // Load Room
router.get("/item/Room/:year", authCheck, function (req, res) {
    const year = req.params.year
...
// // Load location
router.get("/item/location/:email/:year", authCheck, function (req, res) {
    const email = req.params.email;
    const year = req.params.year;
...
// // Load Status
router.get("/item/Status/:year", authCheck, function (req, res) {
    const year = req.params.year
    const sql = "SELECT DISTINCT Status FROM item where year=?"
...
// // Load Status
router.get("/item/Status/:email/:year", authCheck, function (req, res) {
    const email = req.params.email;
    const year = req.params.year;
...
router.get("/item/dashboard/showAllInfo1/:status/:email/:year", authCheck, function (req, res) {
    const status = req.params.status;
    const email = req.params.email;
    const year = req.params.year;
...
router.get("/item/dashboard/showAllInfostatus/:status/:year", authCheck, function (req, res) {
    const status = req.params.status;
    const year = req.params.year;
...
// // Load Year
router.get("/item/Year", authCheck, function (req, res) {
...
// // Load Year
router.get("/item/Yearuser/:email", authCheck, function (req, res) {
    const email = req.params.email;
...
router.get("/item/dashboard/showAllInfo4/:Year", authCheck, function (req, res) {
    const Year = req.params.Year;
...
// // Load commitee
router.get("/item/Email_Committee/:year", authCheck, function (req, res) {
    const year = req.params.year;
...
router.get("/item/dashboard/showAllInfo3/:Email_Committee/:Year", authCheck, function (req, res) {
...
// Load item info
router.get("/item/:status", authCheck, function (req, res) {
...
router.get("/item/forPrintQRcode_Barcode/:Email_Committee", authCheck, function (req, res) {
...
router.get("/landing1/showSomeInfo", authCheck, function (req, res) {
...
router.get("/landing1/showAllInfo", authCheck, function (req, res) {
...
router.get("/landing2/showSomeInfo", authCheck, function (req, res) {
...
router.get("/item/numberAll", authCheck, function (req, res) {
    const Year = new Date().getFullYear();
...
router.get("/dateTime/showDateTime", authCheck, function (req, res) {
...
// Edit status of item
router.put("/item/edit", authCheck, function (req, res) {
    const Status = req.body.Status;
    const Inventory_Number = req.body.Inventory_Number;
...
// delete user
router.delete("/manageUser/deleteAllUser/:Email", authCheck, function (req, res) {
    const Email = req.params.Email;
...
// delete item
router.delete("/manageItem/deleteAllitem", authCheck, function (req, res) {
    // const Year = new Date().getFullYear();
...
router.get("/manageUser/showAllUser/:Year", authCheck, function (req, res) {
    const Year = req.params.Year;
...
// Load mane
router.get("/manageUser/showAlladminname", authCheck, function (req, res) {
...
// Add info of new user in manage user page
router.post("/manageUser/add/:Email_user/:Email_assigner/:Role", authCheck, function (req, res) {
    // const Year = new Date().getFullYear();
    const Email_user = req.params.Email_user;
    const Email_assigner = req.params.Email_assigner;
    const Role = req.params.Role;
...
router.get("/con/:Inventory_Number/:Year", authCheck, function (req, res) {
...
router.get("/numberitem", authCheck, function (req, res) {
    // const Year = new Date().getFullYear();
...
// Insert Work Time
router.post("/dateTime/insertTime/:Date_start/:Date_end", authCheck, function (req, res) {
...
// Update date
router.put("/dateTime/updateTime/:Date_start/:Date_end", authCheck, function (req, res) {
    const Date_start = req.params.Date_start;
    const Date_end = req.params.Date_end;
...
router.post("/UploadingPhoto", authCheck, function (req, res) {
    upload(req, res, function (err) {
        if (err) {
            // An unknown error occurred when uploading.
            console.log(err);
...
//upload annonce
router.post("/AddAnnounce/:EmailOwner", authCheck, function (req, res) {
...
//update announce
router.put("/EditAnnounce/:EmailOwner/:Number1", authCheck, function (req, res) {
    const EmailOwner = req.params.EmailOwner
...
//delete announce
router.delete("/DeleteAnnounce/:Number1", authCheck, function (req, res) {
    // const EmailOwner = req.params.EmailOwner
    const Number1 = req.params.Number1
